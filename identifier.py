...
def find_similar_artworks(image_path, top_k=5):
    """
    Returns the most visually similar artworks
    ...
    for idx in sorted_indices[:top_k]:
        ...
        artwork_id = int(reference_ids[idx])

        artwork = artworks_dict[artwork_id].copy()

        artwork["similarity"] = float(similarities[idx])
