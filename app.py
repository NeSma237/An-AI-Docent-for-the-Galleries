...
CONTEXT_KEYS = [
    ...
    "Department", "Materials", "Story", "Symbols", "Artist Biography","Historical Context", "Interesting Facts"
]
...
def handle_question(question, doc, room_slot):
    ...
    stage_line = st.empty()
    stage_line.markdown(
        '<div class="pipeline-line">🎨 Consulting ArtMuse...</div>',
        unsafe_allow_html=True
    )
    ...
    context = build_context(doc, question)
    ...
    stage_line.markdown(
        '<div class="pipeline-line">✍️ Writing response...</div>',
        unsafe_allow_html=True
    )
...
""",
        ...
        with st.spinner("🧠 Searching Museum Archive..."):
            doc = retrieve_context(artwork_id=artwork["id"])
...
""",
        ...
        f"""
<div class="magazine-section">
  <div class="eyebrow eyebrow-gold">Symbols</div>
...
""",
        unsafe_allow_html=True
            ...
            if parsed_context.get("Historical Context"):
               st.markdown(
        f"""
<div class="magazine-section">
  <div class="eyebrow eyebrow-gold">Historical Context</div>
  <p class="magazine-body">{parsed_context["Historical Context"]}</p>
</div>
""",
        unsafe_allow_html=True
    )
        ...
        f"""
<div class="magazine-section">
  <div class="eyebrow eyebrow-gold">About the Artist</div>
...
""",
        unsafe_allow_html=True
            ...
            if parsed_context.get("Interesting Facts"):
               st.markdown(
        f"""
<div class="magazine-section">
  <div class="eyebrow eyebrow-gold">Interesting Facts</div>
  <p class="magazine-body">{parsed_context["Interesting Facts"]}</p>
</div>
""",
        unsafe_allow_html=True
    )
